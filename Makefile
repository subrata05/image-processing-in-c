...
A lightweight command-line tool written in C for loading, transforming, and saving BMP image files. Supports a wide range of rotations and flips, including batch operations.
